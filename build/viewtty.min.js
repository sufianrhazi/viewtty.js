(()=>{(()=>{var U=Object.create,O=Object.defineProperty,V=Object.getOwnPropertyDescriptor,K=Object.getOwnPropertyNames,j=Object.getPrototypeOf,Y=Object.prototype.hasOwnProperty,X=(d,b)=>function(){return b||(0,d[K(d)[0]])((b={exports:{}}).exports,b),b.exports},G=(d,b,g,M)=>{if(b&&typeof b=="object"||typeof b=="function")for(let x of K(b))!Y.call(d,x)&&x!==g&&O(d,x,{get:()=>b[x],enumerable:!(M=V(b,x))||M.enumerable});return d},W=(d,b,g)=>(g=d!=null?U(j(d)):{},G(b||!d||!d.__esModule?O(g,"default",{value:d,enumerable:!0}):g,d)),z=X({"ext/term.cjs"(d,b){"use strict";(function(){"use strict";var g=this,M=this.document;function x(){this._events=this._events||{}}x.prototype.addListener=function(t,s){this._events[t]=this._events[t]||[],this._events[t].push(s)},x.prototype.on=x.prototype.addListener,x.prototype.removeListener=function(t,s){if(this._events[t]){for(var e=this._events[t],i=e.length;i--;)if(e[i]===s||e[i].listener===s){e.splice(i,1);return}}},x.prototype.off=x.prototype.removeListener,x.prototype.removeAllListeners=function(t){this._events[t]&&delete this._events[t]},x.prototype.once=function(t,s){function e(){var i=Array.prototype.slice.call(arguments);return this.removeListener(t,e),s.apply(this,i)}return e.listener=s,this.on(t,e)},x.prototype.emit=function(t){if(this._events[t])for(var s=Array.prototype.slice.call(arguments,1),e=this._events[t],i=e.length,n=0;n<i;n++)e[n].apply(this,s)},x.prototype.listeners=function(t){return this._events[t]=this._events[t]||[]};var y=0,_=1,S=2,L=3,A=4,D=5,E=6;function r(t){var s=this;if(!(this instanceof r))return new r(arguments[0],arguments[1],arguments[2]);x.call(this),typeof t=="number"&&(t={cols:arguments[0],rows:arguments[1],handler:arguments[2]}),t=t||{},I(N(r.defaults),function(i){t[i]==null&&(t[i]=r.options[i],r[i]!==r.defaults[i]&&(t[i]=r[i])),s[i]=t[i]}),t.colors.length===8?t.colors=t.colors.concat(r._colors.slice(8)):t.colors.length===16?t.colors=t.colors.concat(r._colors.slice(16)):t.colors.length===10?t.colors=t.colors.slice(0,-2).concat(r._colors.slice(8,-2),t.colors.slice(-2)):t.colors.length===18&&(t.colors=t.colors.slice(0,-2).concat(r._colors.slice(16,-2),t.colors.slice(-2))),this.colors=t.colors,this.options=t,this.parent=t.body||t.parent||(M?M.getElementsByTagName("body")[0]:null),this.cols=t.cols||t.geometry[0],this.rows=t.rows||t.geometry[1],t.handler&&this.on("data",t.handler),this.ybase=0,this.ydisp=0,this.x=0,this.y=0,this.cursorState=0,this.cursorHidden=!1,this.convertEol,this.state=0,this.queue="",this.scrollTop=0,this.scrollBottom=this.rows-1,this.applicationKeypad=!1,this.applicationCursor=!1,this.originMode=!1,this.insertMode=!1,this.wraparoundMode=!1,this.normal=null,this.prefixMode=!1,this.selectMode=!1,this.visualMode=!1,this.searchMode=!1,this.searchDown,this.entry="",this.entryPrefix="Search: ",this._real,this._selected,this._textarea,this.charset=null,this.gcharset=null,this.glevel=0,this.charsets=[null],this.decLocator,this.x10Mouse,this.vt200Mouse,this.vt300Mouse,this.normalMouse,this.mouseEvents,this.sendFocus,this.utfMouse,this.sgrMouse,this.urxvtMouse,this.element,this.children,this.refreshStart,this.refreshEnd,this.savedX,this.savedY,this.savedCols,this.readable=!0,this.writable=!0,this.defAttr=131840,this.curAttr=this.defAttr,this.params=[],this.currentParam=0,this.prefix="",this.postfix="",this.lines=[];for(var e=this.rows;e--;)this.lines.push(this.blankLine());this.tabs,this.setupStops()}H(r,x),r.prototype.eraseAttr=function(){return this.defAttr&-512|this.curAttr&511},r.tangoColors=["#2e3436","#cc0000","#4e9a06","#c4a000","#3465a4","#75507b","#06989a","#d3d7cf","#555753","#ef2929","#8ae234","#fce94f","#729fcf","#ad7fa8","#34e2e2","#eeeeec"],r.xtermColors=["#000000","#cd0000","#00cd00","#cdcd00","#0000ee","#cd00cd","#00cdcd","#e5e5e5","#7f7f7f","#ff0000","#00ff00","#ffff00","#5c5cff","#ff00ff","#00ffff","#ffffff"],r.colors=function(){var t=r.tangoColors.slice(),s=[0,95,135,175,215,255],e;for(e=0;e<216;e++)i(s[e/36%6|0],s[e/6%6|0],s[e%6]);for(e=0;e<24;e++)s=8+e*10,i(s,s,s);function i(h,o,f){t.push("#"+n(h)+n(o)+n(f))}function n(h){return h=h.toString(16),h.length<2?"0"+h:h}return t}(),r.colors[256]="#000000",r.colors[257]="#f0f0f0",r._colors=r.colors.slice(),r.vcolors=function(){for(var t=[],s=r.colors,e=0,i;e<256;e++)i=parseInt(s[e].substring(1),16),t.push([i>>16&255,i>>8&255,i&255]);return t}(),r.defaults={colors:r.colors,convertEol:!1,termName:"xterm",geometry:[80,24],cursorBlink:!0,visualBell:!1,popOnBell:!1,scrollback:1e3,screenKeys:!1,debug:!1,useStyle:!1},r.options={},I(N(r.defaults),function(t){r[t]=r.defaults[t],r.options[t]=r.defaults[t]}),r.focus=null,r.prototype.focus=function(){r.focus!==this&&(r.focus&&r.focus.blur(),this.sendFocus&&this.send("\x1B[I"),this.showCursor(),r.focus=this)},r.prototype.blur=function(){r.focus===this&&(this.cursorState=0,this.refresh(this.y,this.y),this.sendFocus&&this.send("\x1B[O"),r.focus=null)},r.prototype.initGlobal=function(){var t=this.document;r._boundDocs=r._boundDocs||[],!~st(r._boundDocs,t)&&(r._boundDocs.push(t),r.bindPaste(t),r.bindKeys(t),r.bindCopy(t),this.isMobile&&this.fixMobile(t),this.useStyle&&r.insertStyle(t,this.colors[256],this.colors[257]))},r.bindPaste=function(t){var s=t.defaultView;C(s,"paste",function(e){var i=r.focus;if(i)return e.clipboardData?i.send(e.clipboardData.getData("text/plain")):i.context.clipboardData&&i.send(i.context.clipboardData.getData("Text")),i.element.contentEditable="inherit",k(e)})},r.bindKeys=function(t){C(t,"keydown",function(s){if(r.focus){var e=s.target||s.srcElement;if(e&&(e===r.focus.element||e===r.focus.context||e===r.focus.document||e===r.focus.body||e===r._textarea||e===r.focus.parent))return r.focus.keyDown(s)}},!0),C(t,"keypress",function(s){if(r.focus){var e=s.target||s.srcElement;if(e&&(e===r.focus.element||e===r.focus.context||e===r.focus.document||e===r.focus.body||e===r._textarea||e===r.focus.parent))return r.focus.keyPress(s)}},!0),C(t,"mousedown",function(s){if(r.focus){var e=s.target||s.srcElement;if(e){do if(e===r.focus.element)return;while(e=e.parentNode);r.focus.blur()}}})},r.bindCopy=function(t){var s=t.defaultView;C(s,"copy",function(e){var i=r.focus;if(i&&i._selected){var n=i.getCopyTextarea(),h=i.grabText(i._selected.x1,i._selected.x2,i._selected.y1,i._selected.y2);i.emit("copy",h),n.focus(),n.textContent=h,n.value=h,n.setSelectionRange(0,h.length),P(function(){i.element.focus(),i.focus()},1)}})},r.prototype.fixMobile=function(t){var s=this,e=t.createElement("textarea");e.style.position="absolute",e.style.left="-32000px",e.style.top="-32000px",e.style.width="0px",e.style.height="0px",e.style.opacity="0",e.style.backgroundColor="transparent",e.style.borderStyle="none",e.style.outlineStyle="none",e.autocapitalize="none",e.autocorrect="off",t.getElementsByTagName("body")[0].appendChild(e),r._textarea=e,P(function(){e.focus()},1e3),this.isAndroid&&C(e,"change",function(){var i=e.textContent||e.value;e.value="",e.textContent="",s.send(i+"\r")})},r.insertStyle=function(t,s,e){var n=t.getElementById("term-style");if(!n){var i=t.getElementsByTagName("head")[0];if(i){var n=t.createElement("style");n.id="term-style",n.innerHTML=`.terminal {
  float: left;
  border: `+s+` solid 5px;
