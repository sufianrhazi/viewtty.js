...
`,f:"\xB0",g:"\xB1",h:"\u2424",i:"\v",j:"\u2518",k:"\u2510",l:"\u250C",m:"\u2514",n:"\u253C",o:"\u23BA",p:"\u23BB",q:"\u2500",r:"\u23BC",s:"\u23BD",t:"\u251C",u:"\u2524",v:"\u2534",w:"\u252C",x:"\u2502",y:"\u2264",z:"\u2265","{":"\u03C0","|":"\u2260","}":"\xA3","~":"\xB7"},r.charsets.UK=null,r.charsets.US=null,r.charsets.Dutch=null,r.charsets.Finnish=null,r.charsets.French=null,r.charsets.FrenchCanadian=null,r.charsets.German=null,r.charsets.Italian=null,r.charsets.NorwegianDanish=null,r.charsets.Spanish=null,r.charsets.Swedish=null,r.charsets.Swiss=null,r.charsets.ISOLatin=null;function C(t,s,e,i){t.addEventListener(s,e,i||!1)}function L(t,s,e,i){t.removeEventListener(s,e,i||!1)}function M(t){return t.preventDefault&&t.preventDefault(),t.returnValue=!1,t.stopPropagation&&t.stopPropagation(),t.cancelBubble=!0,!1}function H(t,s){function e(){this.constructor=t}e.prototype=s.prototype,t.prototype=new e}function tt(t){var s=t.getElementsByTagName("body")[0],e=t.createElement("span");e.innerHTML="hello world",s.appendChild(e);var i=e.scrollWidth;e.style.fontWeight="bold";var n=e.scrollWidth;return s.removeChild(e),i!==n}var B=this.String,P=this.setTimeout,q=this.setInterval;function st(t,s){for(var e=t.length;e--;)if(t[e]===s)return e;return-1}function F(t){return t<="\uFF00"?!1:t>="\uFF01"&&t<="\uFFBE"||t>="\uFFC2"&&t<="\uFFC7"||t>="\uFFCA"&&t<="\uFFCF"||t>="\uFFD2"&&t<="\uFFD7"||t>="\uFFDA"&&t<="\uFFDC"||t>="\uFFE0"&&t<="\uFFE6"||t>="\uFFE8"&&t<="\uFFEE"}function A(t,s,e){var i=t<<16|s<<8|e;if(A._cache[i]!=null)return A._cache[i];for(var n=1/0,h=-1,o=0,f,u,p,a,l;o<r.vcolors.length;o++){if(f=r.vcolors[o],u=f[0],p=f[1],a=f[2],l=A.distance(t,s,e,u,p,a),l===0){h=o;break}l<n&&(n=l,h=o)}return A._cache[i]=h}A._cache={},A.distance=function(t,s,e,i,n,h){return Math.pow(30*(t-i),2)+Math.pow(59*(s-n),2)+Math.pow(11*(e-h),2)};function I(t,s,e){if(t.forEach)return t.forEach(s,e);for(var i=0;i<t.length;i++)s.call(e,t[i],i,t)}function N(t){if(Object.keys)return Object.keys(t);var s,e=[];for(s in t)Object.prototype.hasOwnProperty.call(t,s)&&e.push(s);return e}r.EventEmitter=m,r.inherits=H,r.on=C,r.off=L,r.cancel=M,typeof y<"u"?y.exports=r:this.Terminal=r}).call(function(){return this||(typeof window<"u"?window:global)}())}}),$=class{constructor(){this._chunks=null,this._frame=0,this._startTime=null,this._tickHandle=null,this.listeners=[]}load(d){this._chunks=d,this.rewind()}addListener(d){this.listeners.push(d)}removeListener(d){this.listeners=this.listeners.filter(function(y){return d!==y})}play(){return this._tickHandle||this._frame>=this._chunks.length?!0:(this._emit("play"),this._step(),!1)}_emit(d,y){this.listeners.forEach(b=>{try{b({type:d,data:y})}catch(x){setTimeout(function(){throw x},0)}})}pause(){this._tickHandle&&(this._emit("pause"),clearTimeout(this._tickHandle),this._tickHandle=null,this._startTime=null)}rewind(){this.pause(),this._emit("rewind"),this._frame=0}_step(){var d;this._startTime===null?(this._startTime=new Date().getTime()-this._chunks[this._frame].ms,d=this._startTime):d=new Date().getTime();var y=d-this._startTime,b=[],x=this._frame,m;let v;for(v=this._frame;v<this._chunks.length&&this._chunks[v].ms<=y;++v)b.push(this._chunks[v]);if(this._frame=v,b.forEach(S=>{this._emit("data",{data:S.data,frame:x,ms:S.ms})}),this._frame<this._chunks.length){var _=this._chunks[this._frame].ms-y;this._tickHandle=setTimeout(()=>this._step(),_)}else this._emit("end")}};function J(d){for(var y="",b=0;b<d.length;++b){var x=d[b],m;if(x&128){if(m=0,d[b]&64)if(!(d[b]&32))m=1,x=d[b]&31;else if(!(d[b]&16))m=2,x=d[b]&15;else if(!(d[b]&8))m=3,x=d[b]&7;else throw new Error("Bad UTF-8 Sequence: more than 6 additional chars");else throw new Error("Bad UTF-8 Sequence: mismatch");for(var v=0;v<m;++v){if(b++,b>=d.length)throw new Error("Bad UTF-8 Sequence: need more data");x=x<<6|d[b]&63}if(x>1114111)throw new Error("Bad UTF-8 Sequence: code point too large");if(x>65535){var _=x-65536,S=55296+((_&1047552)>>10),T=56320+(_&1023);y+=String.fromCharCode(S)+String.fromCharCode(T)}else y+=String.fromCharCode(x)}else y+=String.fromCharCode(x)}return y}var Z=class{parse(d){for(var y=[],b=null,x=0;x<d.byteLength;){var m=new Uint32Array(d.slice(x+0,x+12)),v=m[0],_=m[1],S=m[2],T;b===null?(b=v*1e3+_/1e3,T=0):T=v*1e3+_/1e3-b,x+=12;var E=J(new Uint8Array(d.slice(x+0,x+S)));x+=S,y.push({ms:T,data:E})}return y}},Q=W(z()),et={Parser:Z,Player:$,Terminal:Q.default}})();})();
